...
#dog_audio_files = [os.path.abspath(f) for f in dog_audio_files]
#person_audio_files = [os.path.abspath(f) for f in person_audio_files]

keyword_dict = {"beep": {"left_low": 6, "left_high": 7, "right_low": 8, "right_high": 9}}

mystery_dict = {"dog": {"left": "./Audio/dog-left.wav", "front": "./Audio/dog-front.wav", "right": "./Audio/dog-right.wav"}, "person":
{"left": "./Audio/person-left.wav", "front": "./Audio/person-front.wav", "right": "./Audio/person-right.wav"}}
